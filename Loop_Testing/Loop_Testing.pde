...
int x;
int randSize;
int yDist1,xDist1,yDist2,xDist2,yDist3,xDist3,yDist4,xDist4,yDist5,xDist5,yDist6,xDist6,yDist7,xDist7;
boolean isOver;
boolean circleOver1,circleOver2,circleOver3,circleOver4,circleOver5,circleOver6,circleOver7,circleOver8;
boolean click1,click2,click3,click4,click5,click6,click7,click8;
float smoothScale1, smoothScale2, smoothScale3, smoothScale4, smoothScale5, smoothScale6, smoothScale7, smoothScale8;
...
void circleCreate(float x, float y, float randomSize){
...
boolean mouseOver(int randomSize, int x, int y){
